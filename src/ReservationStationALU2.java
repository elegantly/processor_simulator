...
public class ReservationStationALU2 {
	...
	{		
		for(ReservationStationEntry rse_dispatch : ReservationStationALU2.rseSet)
		{	
			...
			boolean EUFree = ExecutionUnitALU2.freeForDispatch;
			if(!ExecutionUnitALU2.freeForDispatch) System.err.println("For some reason the EU ins't ready for dispatch"); //todo: remove after subpipelining
