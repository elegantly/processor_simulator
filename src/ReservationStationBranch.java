...
public class ReservationStationBranch {
	...
	{		
		for(ReservationStationEntry rse_dispatch : ReservationStationBranch.rseSet)
		{	
			...
			if(EUFree && vbits && !dependency)
			{
				if(rseSet.remove(rse_dispatch)==false)
					System.err.println("Trying to remove entry from RSBranch which doesnt exist...IDIOT!");
